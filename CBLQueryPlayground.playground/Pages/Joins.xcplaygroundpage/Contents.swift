...
/*:
 ...
 The opens the database from prebuilt travel-sample database in `playgroundSharedDataDirectory`. The pre-built "joindb.cblite2" folder copied over to the ~/Documents/Shared\ Playground\ Data/ folder
...
func createOrOpenDatabase() throws -> Database? {
    ...
    let travelsampleFile = sharedDocumentDirectory.appendingPathComponent("joindb.cblite2", isDirectory: false)
